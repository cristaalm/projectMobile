...
object RenovaColors {
    ...
    object Light {
        ...
        val TotalCard = TotalBackground
        val AluminumCardIcon = Color(0xFF00BCD4)
    ...
    object Dark {
        ...
        val PlasticCard = Color(0xFF2F7E37)
        val AluminumCard = Color(0xFF005E70)
        val TotalCard = Color(0xFFBCE519)
        val AluminumCardIcon = Color(0xFF00BCD4)
